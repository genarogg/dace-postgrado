...
return new class extends Migration
{
    ...
    {
        Schema::table('inscripcions', function (Blueprint $table) {
            $table->dropForeign('inscripcions_carrera_id_foreign');
            $table->dropForeign('inscripcions_estudiante_id_foreign');
            $table->dropForeign('inscripcions_periodo_id_foreign');
            $table->dropForeign('inscripcions_sede_id_foreign');
        });
    }
};
